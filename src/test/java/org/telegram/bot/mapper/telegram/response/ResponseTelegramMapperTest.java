...
class ResponseTelegramMapperTest {
    ...
    private final ResponseTelegramMapper responseTelegramMapper = new ResponseTelegramMapper(List.of(textMapper), List.of(fileMapper), mediaGroupMapper, botStats);
    ...
    void init() {
        ...
        ReflectionTestUtils.invokeMethod(responseTelegramMapper, "postConstruct");
    }
    ...
    void toTelegramTextMethodUnknownResponseTest() {
        ...
        IllegalArgumentException illegalArgumentException = assertThrows((IllegalArgumentException.class), () -> responseTelegramMapper.toTelegramMethod(responses));
