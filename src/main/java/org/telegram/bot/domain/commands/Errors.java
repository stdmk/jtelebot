...
public class Errors implements CommandParent<PartialBotApiMethod<?>> {
    ...
    public PartialBotApiMethod<?> parse(Update update) {
        ...
        if (textMessage != null) {
            ...
            StringBuilder buf = new StringBuilder("<b>Список ошибок:</b>\n");
            ...
            buf.append("\nОчистить — /errors" + CLEAR_ERRORS_COMMAND);
    ...
    private InputFile getDataFromError(Error error) {
        try {
            ...
            botStats.incrementErrors(error, e, "ошибка при сборке zip-файла из Error");
