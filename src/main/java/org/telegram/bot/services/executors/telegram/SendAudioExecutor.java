package org.telegram.bot.services.executors.telegram;
...
@Service
@Slf4j
public class SendAudioExecutor implements TelegramMethodExecutor {
    ...
    public String getMethod() {
        return SendAudio.PATH;
    }

    @Override
    public void executeMethod(PartialBotApiMethod<?> method, BotRequest request) {
        Message message = request.getMessage();
        SendAudio sendAudio = (SendAudio) method;
        log.info("To {}: {}", message.getChatId(), sendAudio.getCaption());
